...
<Avatar alt="Natacha" size="sm"><PlusOutlined /></Avatar>`;
  ...
  <Avatar alt="Jone Doe" src={avatarImage('./avatar-6.png').default} />
  <Avatar alt="Lein Ket" src={avatarImage('./avatar-7.png').default} />
  <Avatar alt="Stebin Ben" src={avatarImage('./avatar-8.png').default} />
  <Avatar alt="Wungh Tend" src={avatarImage('./avatar-9.png').default} />
  <Avatar alt="Trevor Das" src={avatarImage('./avatar-10.png').default} />
</AvatarGroup>
<Box sx={{ width: 186 }}>
  <Tooltip
    open={show}
